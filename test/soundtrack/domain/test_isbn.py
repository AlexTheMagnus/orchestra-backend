...
class TestIsbn13():
    ...
    def test_from_string_constructor(self):
        str_isbn_13 = str(uuid.uuid4())
        isbn_13 = Isbn13.from_string(str_isbn_13)
        assert isbn_13.value == str_isbn_13

    def test_building_isbn_13_with_a_non_valid_isbn_13_throws_an_error(self):
        str_isbn_13 = str(uuid.uuid1())
        with pytest.raises(NotAValidIsbn13Error):
            isbn_13 = SoundtrackId.from_string(str_isbn_13)
